...
<html lang="en">
  ...
  <body>
    ...
    <main class="collection-page">
      ...
      <section class="collection-grid" aria-label="Women's products">
              ...
              <div class="info">
                ...
                <p class="price">
                  <?php if (isset($item["sale_price"])): ?>
                    <span style="color:var(--accent-clr);">$<?= number_format($item["sale_price"]) ?></span>
      ...
      <?php $infoTitle = "WOMEN'S SHOES"; $infoDesc = "Designed for comfort, crafted with care. Our women's collection blends natural materials with modern silhouettes."; ?>
