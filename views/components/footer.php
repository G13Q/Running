  <footer class="footer-top">
      <div class="footer-top-inner">
        <div class="form">
          <p class="subscribe-label">Subscribe to Our Emails</p>
        ...
        <div class="footer-links">
          <div class="footer-col">
            ...
            <ul>
              <li><a href="mailto:help@tor1.com">Live Chat</a></li>
              <li><a href="tel:+1234567890">Call Us</a></li>
              <li><a href="sms:+1234567890">Text Us</a></li>
              <li><a href="mailto:help@tor1.com">help@tor1.com</a></li>
              <li><a href="?route=shop-all">FAQ / Contact Us</a></li>
              <li><a href="?route=account">Returns / Exchanges</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <p class="footer-col-title">Shop</p>
            <ul>
              <li><a href="?route=mens">Men's Shoes</a></li>
              <li><a href="?route=womens">Women's Shoes</a></li>
              <li><a href="?route=sale">Sales</a></li>
          ...
          <div class="footer-col">
            ...
            <ul>
              <li><a href="?route=home">Store Locator</a></li>
              <li><a href="?route=home">Our Story</a></li>
              <li><a href="?route=home">Our Materials</a></li>
              <li><a href="?route=home">Sustainability</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <ul style="margin-top: 31px">
              <li><a href="?route=home">Community Offers</a></li>
        ...
        <div class="footer-social">
          <p class="social-label">Follow the Flock</p>
          <div class="social-icons">
            ...
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Facebook">
              <svg viewBox="0 0 24 24">
                <path
                  d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.413c0-3.025 1.791-4.697 4.533-4.697 1.312 0 2.686.235 2.686.235v2.97h-1.513c-1.491 0-1.956.931-1.956 1.886v2.266h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"
                />
              </svg>
            </a>
